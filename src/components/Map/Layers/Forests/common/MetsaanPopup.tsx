    ...
    <Paper>
      <TableContainer>
        <Table>
          <TableBody>
            <TableRow>
              <TableCell>Main TableRowee species</TableCell>
              <TableCell>{metsaanFiTreeSpecies[p.mainTableRoweespecies] || ''}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Average TableRowee age</TableCell>
              <TableCell>{p.meanage} years</TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Average TableRowee TableRowunk diameter</TableCell>
              <TableCell>{p.meandiameter} cm</TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Average TableRowee height</TableCell>
            ...
            <TableRow>
              <TableCell>Approx. TableRowee stem count</TableCell>
            ...
            <TableRow>
              ...
              <TableCell>
                {metsaanFiDatasources.filter((x: any) => x.id === p.datasource)[0].description || ''}
              </TableCell>
            </TableRow>
            <TableRow>
