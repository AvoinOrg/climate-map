...
import { Checkbox, FormControl, InputLabel, Select, MenuItem, Modal } from '@mui/material'
...
const DataForm = (props) => {
  ...
  const { userProfile, userIntegrations }: any = useContext(UserStateContext)
  ...
  return userProfile ? (
    <div className={classes.root}>
      ...
      <p className={classes.dataHeader}>Let's specify your data.</p>
      ...
      <p className={classes.selectionText}>
        You can choose multiple options to get private access to all your data. You can edit choices later or delete
        profile with easy settings.
      </p>
